...
<div class="form-group col-sm-6">
    {!! Form::label('idcidade', __('models/usuarioCidades.fields.idcidade').':') !!}
...
<!-- Incluidoem Field -->
<div class="form-group col-sm-6">
    {!! Form::label('incluidoem', __('models/usuarioCidades.fields.incluidoem').':') !!}
...
<!-- Idusuario Field -->
<div class="form-group col-sm-6">
    {!! Form::label('idusuario', __('models/usuarioCidades.fields.idusuario').':') !!}
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('usuarioCidades.index') }}" class="btn btn-default">@lang('crud.cancel')</a>
</div>
