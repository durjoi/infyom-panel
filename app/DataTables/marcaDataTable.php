...
class marcaDataTable extends DataTable
{
    ...
    {
        return [
            'idcidade' => new Column(['title' => __('models/marcas.fields.idcidade'), 'data' => 'cidade.descricao'])
,
            'marca_descricao' => new Column(['title' => __('models/marcas.fields.marca_descricao'), 'data' => 'marca_descricao'])
,
            'incluidoem' => new Column(['title' => __('models/marcas.fields.incluidoem'), 'data' => 'incluidoem'])
,
            'idusuario' => new Column(['title' => __('models/marcas.fields.idusuario'), 'data' => 'usuario.nome'])
