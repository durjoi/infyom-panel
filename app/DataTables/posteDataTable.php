...
class posteDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'postes.datatables_actions');
    }
    ...
    {
        return [
            'poste_descricao' => new Column(['title' => __('models/postes.fields.poste_descricao'), 'data' => 'poste_descricao'])
,
            'incluidoem' => new Column(['title' => __('models/postes.fields.incluidoem'), 'data' => 'incluidoem'])
,
            'idusuario' => new Column(['title' => __('models/postes.fields.idusuario'), 'data' => 'usuario.nome'])
